 ...
 */
public class RoomMediaProviderImpl extends BaseProviderImpl implements MediaProvider {

    private final PhotoDao mPhotoDao;
    private final AlbumDao mAlbumsDao;

    RoomMediaProviderImpl(Context context) {
        super(context);
        mPhotoDao = mDatabase.getPhotoDao();
        mAlbumsDao = mDatabase.getAlbumDao();
    }
